{pkgs, ...}: rec {
  mkSymlinkedDotfilesConfig = {
    ...
    #     "tmux/tmux.conf"
    #   ];
    configFilesToLinkF = xdgConfigList: (pkgs.lib.attrsets.genAttrs xdgConfigList genAttrsForSimpleLink);
    ...
    #     "vimrc"
    #   ];
    homeFilesToLinkF = simpleHomeFilesToLink: (pkgs.lib.lists.foldr (a: b: a // b) {} (map genAttrsForSimpleDotLink simpleHomeFilesToLink));
